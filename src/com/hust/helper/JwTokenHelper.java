...
public class JwTokenHelper {
    ...
    private static final String SECRET_KEY = "HMD_HEDSPI_HUST-project-restapi-token-base-authentication-with-jwt";
 
    private static final String ISSUER = "HMD";
 
    private JwTokenHelper() {
        super();
    }
 
    public static String createJWT(UserForAPI user) {
	...
	public static UserForAPI getUserFromToken(String token) {
