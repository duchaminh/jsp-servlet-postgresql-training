...
public class ValidatorUtil {
	  ...
	  public static final Validation<String> nullString = GenericValidation.from(s -> s == null);

	  public static final Validation<Integer> greaterThanZero = GenericValidation.from(s -> s > 0);
	  
	  public static final Validation<Integer> equalsWithZero = GenericValidation.from(s -> s == 0);
